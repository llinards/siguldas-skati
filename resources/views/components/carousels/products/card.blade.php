<figure class="f-carousel__slide relative group border-2 border-transparent hover:border-ss-dark transition-all duration-300 ease-in-out rounded-3xl">
    <a href="{{ $productLink ?? '' }}">
        <div class="relative rounded-3xl overflow-hidden">
            ...
            <div class="absolute inset-0 rounded-3xl pointer-events-none bg-gradient-to-t from-black/30 via-black/20 to-transparent transition-transform duration-300 ease-in-out group-hover:scale-105">
            </div>
        </div>
