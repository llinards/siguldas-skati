        ...
        <div id="galleryCarousel" class="f-carousel">
            <div class="f-carousel__viewport">
                <x-carousels.gallery.card>
                    ...
                    <x-slot name="imageLink">{{ asset('images/gallery/siguldas-skati-house-1-1.jpg') }}</x-slot>
                    <x-slot name="extraImages">
                        {{ json_encode([
                        asset('images/gallery/siguldas-skati-house-1-2.jpg')
                        ]) }}
                    </x-slot>
                </x-carousels.gallery.card>
                <x-carousels.gallery.card>
                    <x-slot name="imageGallery">galleryTwo</x-slot>
                    <x-slot name="imageLink">{{ asset('images/gallery/siguldas-skati-house-2-1.jpg') }}</x-slot>
                    <x-slot name="extraImages">
                        {{ json_encode([
                        asset('images/gallery/siguldas-skati-house-2-2.jpg')
                        ]) }}
                    </x-slot>
                </x-carousels.gallery.card>
                <x-carousels.gallery.card>
                    <x-slot name="imageGallery">galleryThree</x-slot>
                    <x-slot name="imageLink">{{ asset('images/gallery/siguldas-skati-house-3-1.jpg') }}</x-slot>
                    <x-slot name="extraImages">
                        {{ json_encode([
                        asset('images/gallery/siguldas-skati-house-3-2.jpg')
                        ]) }}
                    </x-slot>
                </x-carousels.gallery.card>
                <x-carousels.gallery.card>
                    <x-slot name="imageGallery">galleryFour</x-slot>
                    <x-slot name="imageLink">{{ asset('images/gallery/siguldas-skati-house-4-1.jpg') }}</x-slot>
                    <x-slot name="extraImages">
                        {{ json_encode([
                        asset('images/gallery/siguldas-skati-house-4-2.jpg')
                        ]) }}
                    </x-slot>
                </x-carousels.gallery.card>
            </div>
