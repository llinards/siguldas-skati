<div id="{{ $modalId }}"
    ...
    <div
        class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 flex justify-center items-center p-4 min-h-screen sm:max-w-lg sm:w-full sm:mx-auto">
        <div
            class="w-full flex flex-col bg-white max-h-[90vh] border border-ss-dark shadow-2xs rounded-xl pointer-events-auto">
