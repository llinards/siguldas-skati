<div>
    ...
    <form wire:submit="save">
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-h-sm-mob lg:text-h-mob mb-3 leading-none">
                    {{ __('Rediģēt noteikumu') }} - {{ $rule->getTranslation('title', app()->getLocale()) }}
                </h2>
                ...
                <div class="mt-5">
                    <label for="section" class="block text-sm/6 font-medium text-gray-900">{{ __('Sadaļa') }}</label>
                    <div class="mt-2">
                        <select
                            wire:model="section"
                ...
                <div class="mt-5">
                    <label for="icon_image" class="block text-sm/6 font-medium text-gray-900">
                        {{ __('Attēls') }}
                    </label>
                    <div class="mt-2">
                        <div class="flex flex-col sm:flex-row sm:space-x-6">
                            @if (! $icon_image && $rule->icon_image)
                                <div>
                                    <img
                                        src="{{ Storage::url($rule->icon_image) }}"
                                        alt="{{ __('Pašreizējā ikona') }}"
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="{{ route('dashboard.rules') }}" class="text-sm/6 font-semibold text-gray-900">
                @lang('Atpakaļ')
            </a>
