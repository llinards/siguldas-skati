            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                @if ($headerImages->count() > 0)
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4" wire:sort="updateImageOrder">
                            @foreach ($headerImages as $image)
                                <div class="group relative" wire:key="existing-image-{{ $image->id }}"
                                    wire:sort:item="{{ $image->id }}">
                                    <img src="{{ Storage::url($image->filename) }}" alt="{{ __('Galvenes attēls') }}"
                        ...
                        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                            @foreach ($images as $index => $image)
                                <div class="group relative">
                                    <div class="relative">
                                        <img src="{{ $image->temporaryUrl() }}" alt="{{ __('Priekšskatījums') }}"
                ...
                <div class="mt-5">
                    ...
                    <div class="flex w-full items-center justify-center">
                        <label for="header-images-upload"
                            ...
                            <input id="header-images-upload" type="file" wire:model="images" class="hidden"
                                accept="image/*" multiple wire:loading.attr="disabled" wire:target="images" />
                        </label>
                    </div>
