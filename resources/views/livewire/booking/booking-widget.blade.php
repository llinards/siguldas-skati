    ...
    <div class="mt-3" x-data="{ open: false }">
        ...
        <div class="relative">
            <button type="button" @click="open = ! open"
                class="mt-1 flex w-full items-center justify-between rounded-lg border border-neutral-300 px-3 py-2 text-left text-neutral-800">
                <span>{{ $this->guestsLabel }}</span>
                <svg class="h-4 w-4 text-neutral-500 transition" :class="open && 'rotate-180'" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.06l3.71-3.83a.75.75 0 111.08 1.04l-4.25 4.39a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                </svg>
            </button>

            <div x-show="open" x-cloak @click.outside="open = false" x-transition
                class="absolute z-20 mt-2 w-full rounded-xl border border-neutral-200 bg-white p-4 shadow-lg">
                ...
                @if ($product->children_count > 0)
                    <div class="mt-1 flex items-center justify-between border-t border-neutral-100 py-1 pt-3">
                        <div>
