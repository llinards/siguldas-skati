            ...
            <form action="{{ route('cookieconsent.accept.configuration') }}" method="post" class="cookies__customize">
                ...
                <div class="cookies__sections">
                    ...
                    <div class="cookies__section ">
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details text-ss-dark">@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
                <div class="cookies__save">
                    <x-btn-cookies type="submit" class="w-full cursor-pointer">@lang('cookieConsent::cookies.save')</x-btn-cookies>
                </div>
            </form>
        </div>
    </div>
