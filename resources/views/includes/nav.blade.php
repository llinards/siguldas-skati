<nav class="absolute w-full z-50" x-data="handleMobileMenu()" x-init="init()">
    <div class="container mx-auto flex justify-between items-center px-4 py-8 relative z-50">
        <a href="/{{ app()->getLocale() }}"
            class="flex items-center focus-visible:outline! focus-visible:outline-offset-6! {{ Route::is('home') ? 'focus-visible:outline-white' : 'focus-visible:outline-ss-dark' }}">
        ...
        <button x-on:click="open = !open" class="lg:hidden relative z-50 focus-visible:outline! {{ Route::is('home') ? 'focus-visible:outline-white' : 'focus-visible:outline-ss-dark' }}" :class="open ? 'focus-visible:outline-ss-dark' : 'focus-visible:outline-ss-dark'">
