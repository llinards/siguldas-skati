<header class="relative flex w-full flex-wrap bg-white py-5 text-sm sm:flex-nowrap sm:justify-start">
    <nav class="mx-auto w-full max-w-7xl px-4 sm:flex sm:items-center sm:justify-between">
        ...
        <div id="hs-navbar-example"
            ...
            <div class="mt-5 flex flex-col gap-5 sm:mt-0 sm:flex-row sm:items-center sm:justify-center sm:ps-5">
                <a class="hover:border-b-menu-hover hover:text-menu-hover text-btn-md {{ Route::is('dashboard') ? 'border-b-menu-hover text-menu-hover' : '' }} border-b-1 border-transparent text-center transition-all duration-200 ease-in-out"
                ...
                <a class="hover:border-b-menu-hover hover:text-menu-hover text-btn-md {{ Route::is('dashboard.features*') ? 'border-b-menu-hover text-menu-hover' : '' }} border-b-1 border-transparent text-center transition-all duration-200 ease-in-out"
                ...
                <a class="hover:border-b-menu-hover hover:text-menu-hover text-btn-md {{ Route::is('dashboard.galleries*') ? 'border-b-menu-hover text-menu-hover' : '' }} border-b-1 border-transparent text-center transition-all duration-200 ease-in-out"
